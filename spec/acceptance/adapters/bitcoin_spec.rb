      ...
      [
        {
          ...
          estimatedTxTime: DateTime.iso8601('2016-09-13T15:33:29.126000000+00:00'),
          estimatedTxValue: 499000000,
          confirmations: 115290
        },
        {
          ...
          estimatedTxTime: DateTime.iso8601('2016-09-13T15:20:15.538000000+00:00'),
          estimatedTxValue: 1000000,
          confirmations: 115293
        }
      ]
    )
  end
